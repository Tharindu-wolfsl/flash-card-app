<div class="card mt-5 ms-auto col-lg-5 col-md-8 col-sm-12">
    <div class="card-body d-flex flex-column justify-content-center align-items-center ">
        <span class="form-logo"></span>
        <form class="w-100">
            <div class="my-4">
                <label for="exampleInputEmail1" class="form-label mb-3 "><strong>Name</strong></label>
                <input class="border border-success rounded-pill w-100" type="text" class="form-control" id="exampleInputEmail1" placeholder="Name">
            </div>
            <div class="my-4">
                <label for="exampleInputEmail1" class="form-label mb-3 "><strong>Your email</strong></label>
